...
gulp.task("concatJS", function() {
    gulp.src(["build/js/jquery-1.11.2.min.js", "build/js/bootstrap.min.js", "build/js/scrolloverflow.min.js", "build/js/fullPage.min.js",
        "build/js/drt.min.js"])
...
gulp.task("concatCSS", function() {
    gulp.src(["build/css/bootstrap.min.css", "build/css/fullPage.min.css", "build/css/drtStyles.min.css"])
